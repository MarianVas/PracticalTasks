...
namespace Task9
{
    ...
    class Square : Figure
    {
        ...
        public override void Draw()
        {
            ...
            Console.WriteLine("2)This is the " + className + " class method, and the value in Figure class is: X - " + X + "; Y - " + Y);
        }
    }
    ...
    class Rectangle : Figure
    {
        ...
        public override void Draw()
        {
            ...
            Console.WriteLine("1)This is the " + className + " class method, and the value in Figure class is: X - " + X + "; Y - " + Y);
        }
    }
}
